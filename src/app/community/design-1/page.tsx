    ...
    <div className="min-h-screen landing-grain" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      ...
      <section className="relative min-h-screen flex items-end pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1614680376739-414d95ff43df?auto=format&fit=crop&w=1920&q=80"
            alt=""
            className="w-full h-full object-cover"
            style={{ filter: "brightness(0.25) saturate(0.7)" }}
          />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(8,8,8,1) 0%, rgba(8,8,8,0.5) 40%, rgba(8,8,8,0.2) 100%)" }} />
        </div>
