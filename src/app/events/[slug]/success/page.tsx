...
function SuccessContent() {
  ...
  return (
    ...
    >
      ...
      <p
        className="text-accent text-xs uppercase tracking-[0.35em] mb-4"
      ...
      <h1 className="text-4xl md:text-6xl font-light text-text-primary leading-tight mb-6">
        You&apos;re
        <br />
        <em className="text-accent italic">booked in</em>
      </h1>

      <div className="w-24 h-px bg-accent/40 mb-8" />

      <p
        className="text-text-secondary text-lg leading-relaxed max-w-md mb-4"
        style={{ fontFamily: "Inter, sans-serif", fontWeight: 300 }}
      >
        Thank you for booking at The Collectors Exhibition. A confirmation email has been
        sent to you with your booking details.
      </p>

      <p className="text-text-muted text-sm mb-10" style={{ fontFamily: "Inter, sans-serif" }}>
        Booking reference:{" "}
        <span className="text-text-primary font-medium">{ref}</span>
      </p>
